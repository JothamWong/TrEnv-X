...
func (n *NetworkEnv) VethCIDR() net.IPNet {
	return net.IPNet{
		IP:   n.VethIP(),
		Mask: net.CIDRMask(consts.VethMask, 32),
	}
}
...
func (n *NetworkEnv) VpeerCIDR() net.IPNet {
	return net.IPNet{
		IP:   n.VpeerIP(),
		Mask: net.CIDRMask(consts.VethMask, 32),
	}
...
// The tap device addree
func (n *NetworkEnv) TapCIDR() net.IPNet {
	return net.IPNet{
		IP:   n.TapIP(),
		Mask: net.CIDRMask(consts.HostTapIPMask, 32),
	}
}
...
func (n *NetworkEnv) HostClonedIP() net.IP {
	low := n.idx%254 + 1 // range from [1, 254]
	high := n.idx / 254
	// TODO: remove host cloned ip and use veth address directly?
	return net.IPv4(192, byte(168+high), byte(low), 1)
}

func (n *NetworkEnv) HostClonedCIDR() net.IPNet {
	return net.IPNet{
		IP:   n.HostClonedIP(),
